...
const Services = () => {
  ...
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I am a fullstack developer from Lagos, Nigeria with 2 years of experience in creating frontend and backend projects</motion.p>
